...
from doublecloud.transfer.v1 import endpoint_service_pb2 as doublecloud_dot_transfer_dot_v1_dot_endpoint__service__pb2
...
def add_EndpointServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=doublecloud_dot_transfer_dot_v1_dot_endpoint__service__pb2.GetEndpointRequest.FromString,
                    response_serializer=doublecloud_dot_transfer_dot_v1_dot_endpoint__pb2.Endpoint.SerializeToString,
            ),
            'List': grpc.unary_unary_rpc_method_handler(
                    servicer.List,
                    request_deserializer=doublecloud_dot_transfer_dot_v1_dot_endpoint__service__pb2.ListEndpointsRequest.FromString,
                    response_serializer=doublecloud_dot_transfer_dot_v1_dot_endpoint__service__pb2.ListEndpointsResponse.SerializeToString,
            ),
            'Create': grpc.unary_unary_rpc_method_handler(
                    servicer.Create,
                    request_deserializer=doublecloud_dot_transfer_dot_v1_dot_endpoint__service__pb2.CreateEndpointRequest.FromString,
                    response_serializer=doublecloud_dot_v1_dot_operation__pb2.Operation.SerializeToString,
            ),
            'Update': grpc.unary_unary_rpc_method_handler(
                    servicer.Update,
                    request_deserializer=doublecloud_dot_transfer_dot_v1_dot_endpoint__service__pb2.UpdateEndpointRequest.FromString,
                    response_serializer=doublecloud_dot_v1_dot_operation__pb2.Operation.SerializeToString,
            ),
            'Delete': grpc.unary_unary_rpc_method_handler(
                    servicer.Delete,
                    request_deserializer=doublecloud_dot_transfer_dot_v1_dot_endpoint__service__pb2.DeleteEndpointRequest.FromString,
                    response_serializer=doublecloud_dot_v1_dot_operation__pb2.Operation.SerializeToString,
            ),
    }
